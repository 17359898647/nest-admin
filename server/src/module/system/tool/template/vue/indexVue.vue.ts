export function indexVue(options) {
...
function indexQueryTemplate(columns) {
  let html = ``
...
function indexButtomTemplate(moduleName, businessName) {
  return `
...
function indexTableTemplate(columns, businessName, moduleName) {
...
function handlerExport(moduleName, businessName) {
  let h = ''
