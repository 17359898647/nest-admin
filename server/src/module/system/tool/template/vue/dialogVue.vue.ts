...
export function dialogVue(options) {
...
function generateScriptSetup({ columns, BusinessName, moduleName, businessName, primaryKey, functionName }) {
...
function generateFormData(columns) {
  return columns
...
function generateRulesData(columns) {
  return columns
